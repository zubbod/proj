...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(elementRef, _aboutService) {
    ...
    AboutComponent.prototype.ngOnInit = function () {
        this._aboutService.getArticles().subscribe(function (d) {
            console.log(d);
        });
    };
    ...
    AboutComponent.prototype.sortByTags = function (e) {
        var sortValue = e.target.innerHTML.trim();
        var sorted = [];
        var unsorted = [];
        this.articles.forEach(function (el, i) {
            if (el.tags.find(function () { return el.tags.includes(sortValue); })) {
                sorted.push(el);
            }
            else {
                unsorted.push(el);
...
var AboutService = /** @class */ (function () {
    function AboutService(_http) {
        this._http = _http;
        this.apiUrl = 'api/articles';
    }
    AboutService.prototype.getArticles = function () {
...
/* harmony import */ var angular_svg_icon__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular-svg-icon */ "./node_modules/angular-svg-icon/fesm5/angular-svg-icon.js");
...
var InfoComponent = /** @class */ (function () {
    ...
    InfoComponent.prototype.ngOnInit = function () {
        ...
        this.infoForm.valueChanges
            ...
            _this._data.name = val.name;
            _this._data.email = val.email;
            _this._data.index = val.address.index;
            _this._data.street = val.address.street || '';
            _this._data.city = val.address.city || '';
            _this._data.country = val.address.country || 'Russia';
            _this._data.date = new Date().toLocaleDateString();
        });
    };
    ...
    InfoComponent.prototype.updateValue = function () {
    ...
    InfoComponent.prototype.onSubmit = function (event) {
        if (this.infoForm.status === 'INVALID' || event.key === 'return') {
            event.preventDefault();
        }
        console.log(JSON.stringify(this._data));
    };
    Object.defineProperty(InfoComponent.prototype, "aliases", {
        get: function () {
    ...
    Object.defineProperty(InfoComponent.prototype, "name", {
        get: function () {
    ...
    Object.defineProperty(InfoComponent.prototype, "email", {
        get: function () {
    ...
    Object.defineProperty(InfoComponent.prototype, "address", {
        get: function () {
    ...
    Object.defineProperty(InfoComponent.prototype, "index", {
        get: function () {
    ...
    Object.defineProperty(InfoComponent.prototype, "city", {
        get: function () {
    ...
    Object.defineProperty(InfoComponent.prototype, "street", {
        get: function () {
...
var SelectButtonComponent = /** @class */ (function () {
    ...
    SelectButtonComponent.prototype.onChangeHandler = function (e) {
...
var OwnCustomMaterialModule = /** @class */ (function () {
    function OwnCustomMaterialModule() {
    }
    OwnCustomMaterialModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [],
            imports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](MATERIAL_MODULES),
            exports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](MATERIAL_MODULES),
            providers: [
    ...
    return OwnCustomMaterialModule;
}());
...
var FormDataModel = /** @class */ (function () {
